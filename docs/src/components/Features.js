      ...
      <section className="Features bg-green color-white clearfix">
        <div className="Container Features-grid">
          <Feature title="Works out of the box">
            ParishKit contains a set of polished React components that work out
            of the box.
          </Feature>
          <Feature title="Flexible & composable">
            ParishKit components are build on top of a React UI Primitive for
            endless composability.
          </Feature>
          <Feature title="Enterprise-grade">
            ParishKit features a UI design language for enterprise-grade web
            applications.
          </Feature>
        </div>
      </section>
