...
ParishKit exports a set of building blocks for building tables.
...
ParishKit exports the following components for tables:
...
Virtual tables in ParishKit are easy to create.
ParishKit gives some nice features when working with virtual tables:
