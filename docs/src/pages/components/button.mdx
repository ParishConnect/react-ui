...
## ParishKit exports multiple button components
...
```jsx
<Button appearance="primary">Hi ParishKit!</Button>
```
...
For the use case of creating a button with a single icon ParishKit exports the `IconButton` component.
