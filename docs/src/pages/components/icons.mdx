...
ParishKit uses the amazing [@blueprintjs/icons](https://blueprintjs.com/docs/#icons) package for all of its icons.
...
ParishKit will choose the most appropriate size based on the `size` passed to the icon.
