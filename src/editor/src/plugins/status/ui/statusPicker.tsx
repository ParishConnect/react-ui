...
export class StatusPickerWithoutAnalytcs extends React.Component<Props, State> {
  ...
  private createStatusAnalyticsAndFireFunc: any
  ...
  constructor(props: Props) {
    ...
    this.createStatusAnalyticsAndFireFunc = props.createAnalyticsEvent
  }
  ...
  private handleEscapeKeydown = this.handleCloseStatusPicker(InputMethod.escKey)
