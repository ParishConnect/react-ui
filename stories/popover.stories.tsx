...
const controlUsage = (
  <Popover
    content={({ close }: any) => <ClosablePopoverContent close={close} />}
    display="inline-block"
  >
    {({ isShown, toggle, getRef }: any) => (
      <Button
        // You can use `isShown` to set a properties
        // Use with caution, calculations are based on the width as soon as you toggle it
        isActive={isShown}
        // Use toggle to show/hide the popover
        onClick={toggle}
        // GetRef is used to get the ref of the element we need to run getBoundingClientRect() on
...
storiesOf('popover', module)
  ...
  .add('usages', () => (
    <Box padding={40}>
      ...
      <Pane overflowY="scroll" height={400} background="tint2">
