...
import { Pane, Heading, Code, defaultTheme } from '../src'
...
const CompareGroup = ({ colors }: { colors: any }) => {
  return colors.map(color => <ColorCompare key={color.oldColor} {...color} />)
}

const Group = ({ title, colors }: { title: string; colors: any[] }) => {
  return (
    <Pane marginTop={32}>
